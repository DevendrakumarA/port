    ...
    <div class="row g-0 align-items-center">
      ...
      <div class="col-lg-6 hero-content" data-aos="fade-right" data-aos-delay="100">
        <div class="content-wrapper">
          <h1 class="hero-title">
            Hi, I'm <span>Lakhan Gupta</span>, <br />
            a Full Stack Web Developer
          </h1>
          <p class="lead">
            I build robust, scalable web applications focused on affiliate marketing platforms and interactive online education tools. Passionate about clean code, user-friendly design, and innovative solutions.
          </p>
          ...
          <div class="social-links" data-aos="fade-up" data-aos-delay="400">
            <a href="https://twitter.com/lakhangupta53223" target="_blank" rel="noopener"><i class="bi bi-twitter"></i></a>
            <a href="https://linkedin.com/in/lakhangupta" target="_blank" rel="noopener"><i class="bi bi-linkedin"></i></a>
            <a href="https://github.com/lakhangupta" target="_blank" rel="noopener"><i class="bi bi-github"></i></a>
            <a href="https://instagram.com/lakhangupta" target="_blank" rel="noopener"><i class="bi bi-instagram"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 hero-image" data-aos="fade-left" data-aos-delay="200">
        <div class="image-container">
          ...
          <img src="assets/img/profile/profile-square-1.webp" alt="Lakhan Gupta's Profile" class="img-fluid hero-main-image" />
...
<section id="about" class="about section">
  ...
  <div class="container section-title">
    <h2>About Me</h2>
    <p>Passionate about building meaningful digital experiences with clean, efficient code.</p>
  </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
        <div class="profile-image-wrapper">
          <div class="profile-image">
            <img src="assets/img/profile/profile-square-1.webp" alt="Lakhan Gupta's Profile" class="img-fluid" />
          </div>
      ...
      <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
        <div class="about-content">
          <div class="intro">
            <h2>Hi, I'm Lakhan Gupta - Full Stack Web Developer</h2>
            <p>
              I specialize in developing scalable and efficient web applications with a focus on affiliate marketing platforms and interactive education tools. Skilled in Node.js, Express, Angular, and MongoDB, I’m passionate about turning ideas into functional digital solutions.
            </p>
          </div>
          ...
          <div class="skills-grid">
            <div class="skill-item" data-aos="zoom-in" data-aos-delay="400">
              ...
              <h4>UI/UX Design</h4>
              <p>Creating user-friendly and intuitive designs that enhance the user experience.</p>
            </div>
            <div class="skill-item" data-aos="zoom-in" data-aos-delay="450">
              ...
              <p>Building robust backend and dynamic frontend applications using modern technologies.</p>
            </div>
            <div class="skill-item" data-aos="zoom-in" data-aos-delay="500">
              ...
              <p>Expertise in MongoDB and data optimization for scalable solutions.</p>
            </div>
          </div>
          ...
          <div class="journey-timeline" data-aos="fade-up" data-aos-delay="300">
            <div class="timeline-item">
              ...
              <div class="description">Graduated with B.Tech in Information Technology from SR Groups of Institute, Lucknow</div>
            </div>
            <div class="timeline-item">
              <div class="year">2023 - Present</div>
              <div class="description">Full Stack Developer at Adsdolfin LLP Ltd, working on affiliate marketing platforms</div>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="skills-summary" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <p>
                        Full Stack Developer with over 3 years of experience specializing in scalable web applications and affiliate marketing platforms.
                        Proficient in modern JavaScript frameworks, backend technologies, and DevOps practices to deliver efficient and reliable solutions.
                    </p>
                    ...
                    <div class="skills-badges" data-aos="fade-up" data-aos-delay="600">
                        ...
                        <div class="badge-list">
                            <div class="skill-badge">Node.js Certified</div>
                            <div class="skill-badge">Angular Developer</div>
                            <div class="skill-badge">MongoDB Basics</div>
                            <div class="skill-badge">Git Proficiency</div>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="resume" class="resume section">
    ...
    <div class="container section-title">
        <h2>Resume</h2>
        <p>Showcasing my professional journey and academic accomplishments</p>
    </div>
            ...
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                <div class="experience-section">
                    <div class="section-header">
                        ...
                        <p>Overview of my key roles and contributions in the software development industry.</p>
                    </div>
                    ...
                    <div class="experience-cards">
                        <div class="experience-card" data-aos="zoom-in" data-aos-delay="300">
                            ...
                            <div class="card-body">
                                <p>Leading technical teams and driving strategic technology initiatives for scalable business growth.</p>
                                <ul class="achievements">
                                    <li>Managed cross-functional teams of 15+ members</li>
                                    <li>Implemented Agile methodologies, boosting team efficiency by 40%</li>
                                    <li>Directed digital transformation projects valued over $2M</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="experience-card" data-aos="zoom-in" data-aos-delay="400">
                            ...
                            <div class="card-body">
                                <p>Oversaw development teams and delivered high-quality software solutions aligned with business goals.</p>
                            </div>
                        </div>
                        ...
                        <div class="experience-card" data-aos="zoom-in" data-aos-delay="500">
                            ...
                            <div class="card-body">
                                <p>Collaborated on product lifecycle from design to deployment, ensuring user-centric development.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                <div class="education-section">
                    <div class="section-header">
                        ...
                        <p>Highlights of my formal education and certifications.</p>
                    </div>
                    ...
                    <div class="education-timeline">
                        ...
                        <div class="education-item" data-aos="slide-up" data-aos-delay="300">
                            ...
                            <div class="education-content">
                                ...
                                <p>Specialized in software engineering principles and advanced algorithms.</p>
                            </div>
                        </div>
                        ...
                        <div class="education-item" data-aos="slide-up" data-aos-delay="400">
                            ...
                            <div class="education-content">
                                ...
                                <p>Focused on network systems, database management, and programming fundamentals.</p>
                            </div>
                        </div>
                        ...
                        <div class="education-item" data-aos="slide-up" data-aos-delay="500">
                            ...
                            <div class="education-content">
                                ...
                                <p>Completed a certification program focused on emerging digital technologies and innovation.</p>
                            </div>
                        </div>
                    </div>
                </div>
